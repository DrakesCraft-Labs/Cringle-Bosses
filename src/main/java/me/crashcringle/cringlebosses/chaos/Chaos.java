...
public class Chaos {
    ...
    public static void setup(CringleBosses cb, ItemGroup ig, Research chaosResearch) {
        ...
        SlimefunItemStack spectreOfChaos = new SlimefunItemStack("CRINGLE_SPECTRE_OF_CHAOS", Material.ENDERMAN_SPAWN_EGG,
                "&5Píldora fantasma del caos",
                "",
                "&7Se utiliza para convocar a los fantasmas del caos.",
                "",
                "&cDebe usarse en un altar de invocación adecuado.");
        ...
        Bell bell = new Bell("&4Campana fantasma", potionEffects, ig, chaosBell, RecipeType.ANCIENT_ALTAR, recipe);
        bell.register(cb);
