...
public class Corrupt {
    public static void setup(CringleBosses cb, ItemGroup ig, Research research) {
        ...
        SlimefunItemStack corruptBell = new SlimefunItemStack("CRINGLE_CORRUPT_BELL", Material.BELL,
                "&eCampana de corrupción",
                "",
                "&fEtiquetar jugadores cercanos",
                "&fy dar efecto de corrupción",
                "",
        ...
        Bell bell = new Bell("&5corrupto&4campana", potionEffects, ig, corruptBell, RecipeType.ANCIENT_ALTAR, recipe);
        bell.register(cb);
